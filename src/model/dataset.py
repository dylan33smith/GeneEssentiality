...
class EssentialityDataset(Dataset):
    ...
    def n_classes(self) -> int:
        """Number of classes (3: always_essential, conditional, non_essential)."""
        return 3
...
def create_datasets_from_config(
    ...
    """Create train, val, and test datasets from config/model.yaml.
