"""exp01 — Baseline MLP (2048 -> 512), MSE loss, AdamW + ReduceLROnPlateau."""
...
def _build_mlp(input_dim: int, hidden1: int = 2048, hidden2: int = 512, dropout: float = 0.3) -> nn.Module:
