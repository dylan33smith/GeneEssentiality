"""exp22 — Pairwise margin loss + MSE with gene-packed batching.

Uses GenePackedBatchSampler so each batch contains many rows per gene,
giving the pairwise loss far more within-gene pairs per step than IID batching.
"""
...
def train() -> dict[str, Any]:
    ...
    elog = EpochLog("exp22_pairwise_genepacked")
