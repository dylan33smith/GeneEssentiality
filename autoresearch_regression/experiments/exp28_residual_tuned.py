"""exp28 — Residual model + MSE with exp10-style tuned optimization.

Isolates whether the residual model benefits from lower LR (8e-4), reduced
weight decay (5e-5), and longer ReduceLROnPlateau patience (8).
"""
...
def train() -> dict[str, Any]:
    ...
    wd = float(os.environ.get("WEIGHT_DECAY", "5e-5"))
    ...
    elog = EpochLog("exp28_residual_tuned")
