"""exp21 — Pairwise margin loss + MSE with standard IID batching (control).

Same recipe as old exp09 but with configurable PAIR_MAX_PAIRS (default 512).
Serves as the baseline for comparing gene-packed batching experiments.
"""
...
from autoresearch_regression.experiments._shared import build_mlp, pairwise_ranking_loss
...
def train() -> dict[str, Any]:
    ...
    elog = EpochLog("exp21_pairwise_control")
