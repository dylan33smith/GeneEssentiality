"""exp26 — Residual model + pairwise margin loss + gene-packed batching.

Combines the residual decomposition with pairwise margin ranking via dense
within-gene batches. RANK_WEIGHT and PAIR_MARGIN are env-tunable for sweeps.
"""
...
from autoresearch_regression.experiments._shared import ResidualModel, pairwise_ranking_loss
...
def train() -> dict[str, Any]:
    ...
    elog = EpochLog("exp26_residual_pairwise")
    for epoch in range(epochs):
        ...
        for x, y, gid in train_loader:
            ...
            rank_loss = pairwise_ranking_loss(pred, y, gid, margin=margin)
