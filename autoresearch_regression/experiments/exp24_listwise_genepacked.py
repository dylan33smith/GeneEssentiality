"""exp24 — Listwise KL ranking loss + MSE with gene-packed batching.

Tests whether the listwise (softmax KL) ranking loss benefits from dense
within-gene batching in the same way pairwise does.
"""
...
from autoresearch_regression.experiments._shared import build_mlp, listwise_ranking_loss
...
def train() -> dict[str, Any]:
    ...
    elog = EpochLog("exp24_listwise_genepacked")
