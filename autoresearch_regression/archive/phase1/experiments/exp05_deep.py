"""exp05 — Deeper MLP (2048 -> 1024 -> 512 -> 256)."""
...
class DeepMLP(nn.Module):
    def __init__(self, input_dim: int, hidden_dims: tuple[int, ...] = (2048, 1024, 512, 256),
                 dropout: float = 0.3):
        super().__init__()
...
def train() -> dict[str, Any]:
    ...
    wd = float(os.environ.get("WEIGHT_DECAY", "5e-4"))
