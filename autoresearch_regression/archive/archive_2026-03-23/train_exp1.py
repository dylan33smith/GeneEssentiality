"""Experiment: Wider architecture (4096→2048→512)"""
...
def _wider_mlp(input_dim: int) -> nn.Module:
    hidden1 = int(os.environ.get("HIDDEN1", "4096"))
    hidden2 = int(os.environ.get("HIDDEN2", "2048"))
...
def train() -> None:
    ...
    model = _wider_mlp(input_dim).to(device)
    loss_fn = nn.MSELoss()
