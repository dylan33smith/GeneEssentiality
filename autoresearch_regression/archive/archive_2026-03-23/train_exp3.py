"""Experiment: Huber loss (robust to outliers)"""
...
def train() -> None:
    ...
    delta = float(os.environ.get("HUBER_DELTA", "0.5"))  # Huber delta parameter
    ...
    loss_fn = nn.HuberLoss(delta=delta)  # Huber instead of MSE
    ...
    for epoch in range(epochs):
        ...
        logger.info("epoch %d/%d train_huber=%.6f val_rmse=%.6f lr=%.6f", 
